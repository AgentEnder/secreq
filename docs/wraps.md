...
| `env_secrets` | array (optional)  | [Declared secret](#declared-secrets) names to inject under those same environment-variable names. References and provider locators aren't accepted.                                                                         |
